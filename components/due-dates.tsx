...
export function DueDates() {
  return (
    <section className="py-16 px-6 bg-gradient-to-r from-green-50 to-blue-50 text-black">
      <div className="container mx-auto">
        ...
        <div className="text-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {dueDates.map((date, index) => (
            <Card key={index} className="text-black bg-white/20 border-none backdrop-blur-lg p-6">
              <CardHeader>
