export function TaxRegimeComparison() {
  return (
    <section className="py-16 px-4 sm:px-8 bg-[linear-gradient(to_bottom,#1e3a8a_0%,#1e40af_30%,#1e3a8a_50%,#c7f9cc_70%,#ebf8ff_100%)]
">
      <div className="container mx-auto">
        <h2 className="text-white text-3xl font-bold text-center mb-2">Which Tax Regime is better?</h2>
        <p className="text-white text-center text-gray-600 mb-8">Old Regime or New Regime</p>
